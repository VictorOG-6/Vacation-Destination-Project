(function(){
    ...
    const destLocation = event.target.elements['destination'].value;
    ...
    function createDestinationCard (name, destination, photoUrl, description){
        ...
        cardSubTitle.innerText = destination;
